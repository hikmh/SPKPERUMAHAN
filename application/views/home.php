...
<!-- <body class="bg-gradient-warning bg-opacity-75"> -->
		...
		<div class="container d-flex bd-highlight">
			...
			<div class="p-2 bd-highlight collapse navbar-collapse" style="flex-grow: 0;" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li style="padding: 15px;"><a href="">Home</a></li>
					<li style="padding: 15px;"><a href="">Survey</a></li>
					<li style="padding: 15px; margin-right: 50px;"><a href="">Tentang</a></li>

					<li class="nav-item" style="padding-top: 5px;">
						<a href="<?= base_url('Login/login'); ?>" class="btn btn-md" role="button" aria-disabled="true" style="background-color: #36b9cc; color: white;">Primary link</a>
	...
	<div class="content container" style="height: 100vh; margin-top: 40px;">
