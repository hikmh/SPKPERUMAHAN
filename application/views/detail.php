							...
							endforeach ?>
								...
								<div class="row mb-4">
									<div class="col-lg-6">
										...
										?>
											<img src="<?= base_url('assets/upload/' . $detail['gambar']) ?>" width="100%" />
										<?php
										} else {
									...
									<div class="col-lg-6 py-2">
										<div class="row">
											...
											<div class="btn-group col-xl-12" role="group" style="margin-top: 15px">
												<a data-toggle="tooltip" data-placement="bottom" title="lihat Lokasi" href="<?= $detail['lokasi'] ?>" class="btn rounded-0" style="background-color: #36b9cc; color: white;"><i class="fa fa-map-marker"></i>&nbsp;&nbsp;&nbsp;Lihat Lokasi</a>
											</div>
										</div>
